...
def main():
    ...
    image = Image.open(r"C:\Users\rrsh8\Downloads\test-ner\untitled.png")
    ...
    if uploaded_file is not None:
        ...
        for entity in entities: 
            ...
            if drug_info:
                ...
                df = df.append({'Drug': entity, 'Info': drug_info}, ignore_index=True)
